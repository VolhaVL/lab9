...
<div style="background-color: #560319; padding: 10px;">
	<img src="resources/image.png" width="83" height="53" border="0"
		align="left">
	<div
		style="font-family: 'Trebuchet'; font-size: 30px; height: 53px; margin-left: 120px;">
		Доска объявлений языковой школы "Загадочная Япония"</div>
</div>
